 ...
 */
	...
	function showCalendarData(employeeId){
		...
		for(var i=0;i<tds.length;i++){
			...
			"<br/><span>张三</span>&nbsp&nbsp&nbsp<span>白班</span>&nbsp&nbsp<span class='glyphicon glyphicon-remove-circle' style='color:red'></span>"+
			"<br/><span class='glyphicon glyphicon-plus-sign' style='color:green' ></span>";
			tds[i].innerHTML=tag;
